...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "ID : 01, 03, 04, 05, 07"))
        MainWindow.setStyleSheet("background-color:#4682B4;")

        self.label.setText(_translate("MainWindow", "Process Name : "))
        self.p_name.setStyleSheet("background-color:#DB7093;")
        self.label_2.setText(_translate("MainWindow", "Arrival Time : "))
        self.p_arrival.setStyleSheet("background-color:#DB7093;")
        self.label_3.setText(_translate("MainWindow", "Burst Time : "))
        self.p_burst.setStyleSheet("background-color:#DB7093;")
        self.add_p.setText(_translate("MainWindow", "Add Process"))
        self.add_p.setStyleSheet("background-color:#FF7F50;")
        self.remove_p.setText(_translate("MainWindow", "Remove Process"))
        self.remove_p.setStyleSheet("background-color:#FFA500;")
        self.fcfs.setText(_translate("MainWindow", "FCFS"))
        self.fcfs.setStyleSheet("background-color:#7FFFD4;")
        self.sjf.setText(_translate("MainWindow", "SJF"))

        self.sjf.setStyleSheet("background-color:#DEB887;")
        self.srtf.setText(_translate("MainWindow", "SRTF"))

        self.srtf.setStyleSheet("background-color:#C70039;")
        self.rr.setText(_translate("MainWindow", "RR"))
        self.rr.setStyleSheet("background-color:#8B4513;")
        self.label_4.setText(_translate("MainWindow", "Q :"))
        self.q.setStyleSheet("background-color:#FFDAB9")
        self.label_5.setText(_translate("MainWindow", "Average Waiting :"))
        self.avg_w.setStyleSheet("background-color:#DDA0DD")
        self.label_6.setText(_translate("MainWindow", "Average Turn around :"))
        self.avg_t.setStyleSheet("background-color:#DDA0DD")

        self.tableWidget.setStyleSheet("background-color:#3CB371;")
        self.tableWidget.horizontalHeader().setStyleSheet("background-color:#2E8B57;")
